...
<div class="container">
    <center><h1 style="margin-top: 42px;">BLOGS</h1></center>
    <center><form method="post" action="{{URL::to('addblogs')}}" enctype="multipart/form-data">
        @csrf
 ...
 <table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-success" href="{{URL::to('editblogs',$top->id)}}">edit</a>
            <a class="btn btn-danger" href="{{URL::to('deleteblogs',$top->id)}}">delete</a></td>            
        </tr>
        @endforeach
    </tbody>
 </table>
